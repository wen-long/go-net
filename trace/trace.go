...
*/
package trace // import "github.com/wen-long/go-net/trace"
...
import (
	...
	"github.com/wen-long/go-net/internal/timeseries"
)
...
func init() {
	...
	if pat == debugRequestsPath {
		panic("/debug/requests is already registered. You may have two independent copies of " +
			"github.com/wen-long/go-net/trace in your binary, trying to maintain separate state. This may " +
			"involve a vendored copy of github.com/wen-long/go-net/trace.")
	}
...
var contextKey = contextKeyT("github.com/wen-long/go-net/trace.Trace")
